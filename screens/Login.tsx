      ...
      <ScrollView contentContainerStyle={s.wrap} keyboardShouldPersistTaps="handled">
        ...
        <View style={s.card}>
          ...
          <View style={s.rowBetween}>
            <Pressable style={s.checkRow} onPress={() => setStaySignedIn(v => !v)}>
          ...
          {/* Login button */}
          <Pressable style={s.primaryBtn} onPress={onLogin}>
          ...
          {/* Google */}
          <Pressable style={[s.oauthBtn, s.googleBtn]} onPress={() => {}}>
            <Text style={s.oauthText}>Sign in with Google</Text>
          </Pressable>

          {/* Apple */}
          <Pressable style={[s.oauthBtn, s.appleBtn]} onPress={() => {}}>
...
const s = StyleSheet.create({
  ...
  input: {
    ...
    borderWidth: 1, borderColor: '#23324a',
    borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12,
    color: 'white', fontSize: 16,
  },

  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 6, marginBottom: 14 },

  checkRow: { flexDirection: 'row', alignItems: 'center' },
  checkbox: {
    width: 18, height: 18, borderRadius: 4,
    borderWidth: 1.5, borderColor: '#5b6b84', marginRight: 8,
    alignItems: 'center', justifyContent: 'center',
  ...
  oauthBtn: {
    ...
    borderWidth: 1, borderColor: '#23324a', marginBottom: 10,
    backgroundColor: '#0e1726',
  },
  googleBtn: {},
